...
describe CharactersContext::Dnd5::MakeShortRestCommand do
  ...
  before do
    create :dnd5_character_feature, :bardic_inspiration, slug: 'long_slug'
    create :dnd5_character_feature, :bardic_inspiration, slug: 'short_slug', limit_refresh: 'short_rest'
  end
