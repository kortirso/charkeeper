...
describe Dnd5::Character do
  ...
  describe '#decorator' do
    ...
    before do
      torch = create :item
      melee_weapon = create :item, kind: 'light weapon', info: { type: 'melee', caption: [] }
      thrown_weapon = create :item, kind: 'light weapon', info: { type: 'thrown', caption: [] }
      range_weapon = create :item, kind: 'light weapon', info: { type: 'range', caption: [] }
      armor = create :item, kind: 'light armor', info: { ac: 10 }
      ...
      create :dnd5_character_feature, :bardic_inspiration
    end
