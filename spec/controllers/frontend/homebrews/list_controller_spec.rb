  ...
  describe 'GET#index' do
    context 'for logged users' do
      context 'for Daggerheart' do
        ...
        let!(:feat1) { create :daggerheart_feat, user: user_session.user }
        let!(:race1) { create :homebrew, :daggerheart_ancestry, user: user_session.user }
        let!(:speciality1) { create :homebrew, :daggerheart_class, user: user_session.user }

        before do
          create :daggerheart_feat
          create :homebrew, :daggerheart_ancestry
          create :homebrew, :daggerheart_class
        end
