...
describe HomebrewsV2::Daggerheart::SubclassesController do
  ...
  let!(:own_element) { create :homebrew, :daggerheart_subclass, user: user_session.user }
    ...
    context 'for logged users' do
      ...
      context 'for existing own homebrew' do
        ...
        it 'returns error', :aggregate_failures do
          expect { request }.not_to change(Daggerheart::Homebrews::Subclass, :count)
          expect(response).to have_http_status :not_found
        end
      end
      ...
      context 'for existing homebrew' do
        ...
        it 'creates homebrew', :aggregate_failures do
          expect { request }.to change(Daggerheart::Homebrews::Subclass, :count).by(1)
