  ...
  module Commands
    module Checks
      class DndAttack
        ...
        def rolls(arguments) # rubocop: disable Metrics/AbcSize, Metrics/MethodLength
          ...
          values[:dices].each do |dice|
            ...
            damage_rolls << value
            if values[:crit]
              crit_value = roll_command.call(arguments: [dice]).dig(:result, :total)
          ...
          crit_damage = values[:dices_bonus].to_i + crit_rolls.sum
