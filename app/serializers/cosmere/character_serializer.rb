...
module Cosmere
  class CharacterSerializer < ApplicationSerializer
    ...
    attributes :provider, :id, :name, :created_at, :avatar, :skills, :defense, :health_max, :focus_max, :investiture_max, :load,
               ...
               :goals, :connections, :singer_forms, :singer_form, :names, :setting, :max_abilities, :conditions_v2, :powers

    delegate :skills, :defense, :focus_max, :investiture_max, :load, :movement, :recovery_die, :senses_range, :max_abilities,
             :deflect, :tier, :attacks, :talent_points, :features, :health_max, :modified_abilities, :singer_forms, :powers,
             to: :decorator
