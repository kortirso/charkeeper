...
module Dc20
  class CharacterSerializer < ApplicationSerializer
    attributes :features, :provider, :id, :name, :level, :main_class, :abilities, :modified_abilities, :created_at, :avatar,
               ...
               :spell_lists_amount, :selected_talents, :subclass, :speeds, :jump, :size
    ...
    delegate :features, :id, :name, :level, :main_class, :abilities, :modified_abilities, :health, :attribute_points, :classes,
             ...
             :paths, :mana_points, :maneuvers, :maneuver_points, :stamina_points, :grit_points, :rest_points,
             :mana_spend_limit, :cantrips, :spells, :talent_points, :spell_lists_amount, :speeds, :jump, :size, to: :decorator
    delegate :created_at, :updated_at, :data, to: :object
    delegate :guide_step, :selected_talents, :subclass, to: :data
