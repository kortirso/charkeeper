...
module Dc20
  class CharacterSerializer < ApplicationSerializer
    ...
    attributes :features, :provider, :id, :name, :level, :main_class, :modified_abilities, :created_at, :avatar,
               ...
               :selected_additional_talents, :ancestry_points, :damages, :resistances, :conditions_v2, :abilities
    ...
    delegate :features, :name, :modified_abilities, :health, :combat_mastery, :save_dc, :precision_defense, :breath, :size,
             ...
             :stamina_spend_limit, :cantrips, :spells, :spell_lists_amount, :speeds, :jump, to: :decorator
