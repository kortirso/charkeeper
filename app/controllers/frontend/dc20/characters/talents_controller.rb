  ...
  module Dc20
    module Characters
      class TalentsController < Frontend::Dc20::BaseController
        ...
        def create
          case add_talent.call({ character: @character, talent: @talent, feat: @feat, additional: params[:additional] }.compact)
        ...
        def find_talent
          @talent = ::Dc20::Feat.where(origin: 4).find(params.expect(:talent_id))
        end
