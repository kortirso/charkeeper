...
import { fetchBookRequest, removeBookRequest } from '../../../requests_v2/nimble/books';
...
export const NimbleBooks = () => {
  const [locale] = useAppLocale();
  const [appState] = useAppState();

  const [showItems, setShowItems] = createSignal(false);

  const fetchList = async () => await fetchBooksRequest(appState.accessToken, 'nimble');
