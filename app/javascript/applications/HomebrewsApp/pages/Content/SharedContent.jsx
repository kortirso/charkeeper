      ...
      <Show
        ...
        fallback={
          <>
            ...
            <p class="mb-4"><a target="_blank" rel="noopener noreferrer" class="underline" href="https://github.com/kortirso/charkeeper/blob/master/spec/fixtures">{localize(TRANSLATION, locale()).fileExampleDescription}</a></p>
