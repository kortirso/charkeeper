...
module Fallout
  class CharacterData
    ...
    attribute :attributes, array: true, default: {
      'str' => 5, 'per' => 5, 'end' => 5, 'cha' => 5, 'int' => 5, 'agi' => 5, 'lck' => 5
    }
    attribute :max_attributes, array: true, default: {} # если нет значения - 10
    ...
    attribute :attibute_boosts, :integer, default: 5 # повышение атрибутов
